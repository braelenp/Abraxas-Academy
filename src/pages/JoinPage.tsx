    ...
    <div className="space-y-4">
      <Card className="overflow-hidden">
        ...
        <p className="mt-3 text-sm leading-6 text-slate-300">
          The Genesis NFT is the first door. Mint it with Phantom wallet to open lifetime Academy access, baseline ecosystem yields, a Sovereign Regime ID card, and sovereign-only channels.
        </p>
        ...
        <div className="mt-5 grid gap-3 text-sm text-slate-200/90">
          ...
          <div className="rounded-2xl border border-cyan-300/15 bg-white/[0.03] px-4 py-3">Sovereign Regime ID card with rune, member number, and blessing</div>
      ...
      <Card>
        ...
        <div className="mt-4 rounded-[1.75rem] border border-cyan-300/20 bg-[linear-gradient(145deg,rgba(153,69,255,0.22),rgba(5,5,5,0.82),rgba(0,245,255,0.14))] p-5">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-[10px] uppercase tracking-[0.3em] text-cyan-100/65">Sovereign Regime ID</p>
