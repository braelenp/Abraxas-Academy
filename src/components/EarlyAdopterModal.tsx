    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-51 mx-4 w-full max-w-md overflow-hidden rounded-3xl border border-amber-300/40 bg-black/90 shadow-[0_0_80px_rgba(217,119,6,0.25),0_0_120px_rgba(153,69,255,0.15)] backdrop-blur-2xl">
        ...
        <div className="flex flex-none items-center justify-between border-b border-amber-300/20 bg-black/95 px-6 py-5 backdrop-blur-xl">
          <div>
            <p className="text-xs uppercase tracking-[0.32em] text-amber-300/70">Limited Access</p>
            <h2 className="mt-1 text-lg font-bold text-amber-100">Early Adopter Access</h2>
          </div>
          <button
            onClick={handleClose}
        ...
        <div className="space-y-6 px-6 py-6">
          ...
          <div className="space-y-3">
            <p className="text-sm leading-6 text-slate-200">
              This is early access to the Sovereign Regime.
            </p>
            <p className="text-sm leading-6 text-slate-200">
          ...
          <div className="space-y-3">
            {/* Primary Button */}
            <button
              onClick={() => window.open('https://x.com/cryptoac3y', '_blank')}
            ...
            <button
              onClick={() => window.open('https://x.com/cryptoac3y', '_blank')}
              className="flex w-full items-center justify-center gap-2 rounded-2xl border border-violet-400/40 bg-violet-500/10 px-4 py-3 text-sm font-semibold text-violet-200 transition hover:bg-violet-500/20"
            >
              Follow Founder
            </button>
          </div>
